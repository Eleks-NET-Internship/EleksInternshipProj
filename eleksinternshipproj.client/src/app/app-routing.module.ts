...
const routes: Routes = [
...

  {
    ...
    children: [
      ...
      { path: 'schedule/edit-schedule', component: EditScheduleComponent, canActivate: [authGuard, spaceContextGuard] },
      ...
      { path: 'notes/event-notes', component: EventNotesComponent, canActivate: [authGuard, spaceContextGuard] },
      { path: 'notes/:id', component: NoteDetailComponent, canActivate: [authGuard, spaceContextGuard] },
      { path: 'events/:id', component: EventDetailComponent, canActivate: [authGuard, spaceContextGuard] },
